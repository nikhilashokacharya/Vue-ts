export const labelData=[
    ...
    {
        labelName : 'BorderColor',
        type : 'color',
        value: ''
    },
    {
        labelName : 'BorderStyle',
        type : 'dropdown',
        value: '',
        option:[
            "0-fmBorderStyleNone",
